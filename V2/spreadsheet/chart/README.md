...
<table><thead><tr><th width="223">Property</th><th width="195">Type</th><th>Details</th></tr></thead><tbody><tr><td>showValueFromColumn</td><td>bool</td><td>Show Advanced data label</td></tr><tr><td>valueFromColumn</td><td>Dictionary&#x3C;uint, uint></td><td>This option allows configuring a key map where series corresponds to the key, and the value is mapped to a target column based on cell column configuration.</td></tr></tbody></table>
